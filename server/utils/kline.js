...
function macd_cross() {
  ...
  var dif = output[0]._buf; //dif线
  var dea = output[1]._buf; //dea线
  var column = output[2]._buf; // MACD柱
  var len = dif.length; //K线周期长度
  ...
  console.log(result + '[DIF:' + dif[len - 1] + '][DEA:' + dea[len - 1] + '][MACD:' + column[len - 1] + ']---' + t);
}
